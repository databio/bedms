...
def encoding(
    ...
    return (
        ...
        X_headers_train_encoded,
        X_headers_test_encoded,
        X_headers_val_encoded,
        y_train_encoded,
        y_test_encoded,
        y_val_encoded,
        label_encoder,
...
def to_tensor(
    ...
    X_headers_train_tensor = torch.tensor(
        X_headers_train_encoded.toarray(), dtype=torch.float32
    )
    X_headers_test_tensor = torch.tensor(
        X_headers_test_encoded.toarray(), dtype=torch.float32
    )
    X_headers_val_tensor = torch.tensor(
        X_headers_val_encoded.toarray(), dtype=torch.float32
    )
