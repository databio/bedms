...
class ModelTraining:
    ...
    def train(self, X_train_tensor, X_train_headers_tensor, y_train_tensor, X_val_tensor, X_val_headers_tensor, y_val_tensor, num_epochs=10, batch_size=32, device='cpu'):
