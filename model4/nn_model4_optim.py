...
from nn_model4_train import ModelTraining
import pickle
...
for params in param_combinations:
    ...
    train_accuracies, val_accuracies, train_losses, val_losses=trainer.train(X_train_bow_tensor, X_train_headers_tensor, y_train_tensor,X_val_bow_tensor, X_val_headers_tensor, y_val_tensor, num_epochs=10, batch_size=params['batch_size'], device="cpu")
