...
def data_split(df_values, df_headers):
    ...
    #df_headers_test=pd.read_csv("../data/blueprints_headers_test_apt.tsv", sep="\t")
    #df_values_test=pd.read_csv("../data/blueprints_metadata_test_apt.tsv", sep="\t")
...
def encoding(X_values_train, X_values_test, X_values_val, \
    ...
    return X_values_train_embeddings, X_values_test_embeddings, X_values_val_embeddings, \
        X_headers_train_embeddings, X_headers_test_embeddings, X_headers_val_embeddings, \
            y_train_encoded, y_test_encoded, y_val_encoded, label_encoder, combined_labels

def to_tensor(X_values_train_embeddings, X_values_test_embeddings, X_values_val_embeddings, \
        X_headers_train_embeddings, X_headers_test_embeddings, X_headers_val_embeddings, \
...
if __name__=="__main__":
    values_file_path="../data/blueprints_metadata_distinct.tsv" 
    headers_file_path="../data/blueprints_headers_distinct.tsv"
    ...
    X_values_train_embeddings, X_values_test_embeddings, X_values_val_embeddings, \
        X_headers_train_embeddings, X_headers_test_embeddings, X_headers_val_embeddings, \
    ...
    X_values_train_tensor, X_values_test_tensor, X_values_val_tensor , \
        X_headers_train_tensor , X_headers_test_tensor, X_headers_val_tensor, \
            y_train_tensor, y_test_tensor, y_val_tensor=to_tensor(X_values_train_embeddings, X_values_test_embeddings, X_values_val_embeddings, \
        X_headers_train_embeddings, X_headers_test_embeddings, X_headers_val_embeddings, \
            y_train_encoded, y_test_encoded, y_val_encoded)
    ...
    model=sentence_transformer_NN(input_size_values, input_size_headers, hidden_size, output_size)
