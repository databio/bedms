...
def encoding(X_values_train_list, X_headers_train_list, y_train_list, \
    ...
    flattened_list = [item for sublist in X_values_train_list for col in sublist for item in col]
...
def custom_train(model, criterion, optimizer, train_loader, val_loader, num_epochs, checkpoint_path):
    ...
    torch.save(model.state_dict(), "BoWSTModel6.pth")
    model_path = "trained_model6.pkl"
