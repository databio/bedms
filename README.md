...
Thus model trains on both column values and column headers. It performs bag of words encoding on both. The output for each attribute is top 3 predictions made by the model. There are 4 associated scripts:
